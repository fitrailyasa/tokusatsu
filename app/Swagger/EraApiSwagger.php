 ...
 *     @OA\Property(property="desc", nullable=true, type="string", example="Description Era"),
 ...
 *     required={"name"},
 *     @OA\Property(property="name", type="string", example="Test"),
 *     @OA\Property(property="desc", type="string", nullable=true, example="Description Era Test")
 * )
 */
class EraApiSwagger
{
