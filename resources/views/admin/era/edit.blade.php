...
<button role="button" class="btn btn-sm btn-warning mr-2" data-bs-toggle="modal"
    data-bs-target=".bd-example-modal-sm{{ $era->id }}"><i class="fas fa-edit"></i> Edit</button>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror"
                                placeholder="name" name="name" id="name" value="{{ $era->name }}" required>
                            @error('name')
                ...
                <div class="row">
                    <div class="col-md-12 text-center">
                        <div class="mb-3">
                            ...
                            @else
                                <img class="img-fluid rounded" width="200px" id="image-preview"
                                    src="{{ asset('assets/img/' . $era->img) }}" alt="{{ $era->name }}">
                            @endif
                        </div>
                    </div>
                </div>
