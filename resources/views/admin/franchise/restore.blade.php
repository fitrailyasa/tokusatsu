...
<button role="button" class="btn btn-sm m-1 btn-info" data-bs-toggle="modal"
    data-bs-target=".formRestore{{ $franchise->id }}"><i class="fas fa-undo"></i><span class="d-none d-sm-inline">
        {{ __('Restore') }}</span></button>

<!-- Modal -->
<div class="modal fade formRestore{{ $franchise->id }}" tabindex="-1" role="dialog" aria-hidden="">
