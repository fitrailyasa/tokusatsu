...
<button role="button" class="btn btn-sm btn-danger delete-button" data-bs-toggle="modal"
    data-bs-target=".bd-example-modal-sm{{ $franchise->id }}"><i class="fas fa-trash"></i><span class="d-none d-sm-inline">
        {{ __('Hapus') }}</span></button>

<!-- Modal -->
<div class="modal fade bd-example-modal-sm{{ $franchise->id }}" tabindex="-1" role="dialog" aria-hidden="">
