...
<div class="modal fade formImport" tabindex="-1" role="dialog" aria-labelledby="modalFormLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form method="POST" action="{{ route('admin.franchise.import') }}" enctype="multipart/form-data">
                @csrf
                <div class="modal-header">
                    <h5 class="modal-title" id="modalFormLabel">{{ __('Upload Franchise') }}</h5>
                ...
                <div class="modal-footer">
                    <a class="btn btn-success" href="{{ asset('assets/template/franchise-template.xlsx') }}"
                        download="franchise-template.xlsx">{{ __('Download Format') }}</a>
