    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="d-flex justify-content-between mb-3">
                ...
                <a href="{{ route('admin.data.create') }}" class="btn-sm btn-primary">Tambah</a>
            </div>
            @if (session('sukses'))
                    ...
                    <tbody>
                        @foreach ($datas as $data)
                            <tr>
                                ...
                                <td><a href="{{ asset('assets/img') }}/{{ $data->img }}"><img
                                            src="{{ asset('assets/img/' . $data->img) }}" alt="" width="100px"></a>
                                </td>
                                <td class="manage-row">
                                    @if (auth()->user()->roles_id == 1)
                                        <a href="{{ route('admin.data.show', $data->id) }}"
                                            class="btn-sm btn-success">Detail</a>
                                        <a href="{{ route('admin.data.edit', $data->id) }}"
                                        ...
                                        <!-- Modal -->
                                        <div class="modal fade bd-example-modal-sm{{ $data->id }}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog ">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <form action="{{ route('admin.data.destroy', $data->id) }}"
                                                            method="POST">
                                                            @method('DELETE')
                                                            @csrf
