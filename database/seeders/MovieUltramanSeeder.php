...
class MovieUltramanSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $data = collect([
            ...
            ['title' => 'Ultraman Mebius Side Story: Hikari Saga', 'category_id' => $this->Category('mebius'), 'type' => 'movie', 'number' => 1, 'airdate' => '2006-06-30'],
            ['title' => 'Ultraman Mebius & Ultraman Brothers', 'category_id' => $this->Category('mebius'), 'type' => 'movie', 'number' => 2, 'airdate' => '2006-09-16'],
            ['title' => 'Ultraman Mebius Side Story: Armored Darkness', 'category_id' => $this->Category('mebius'), 'type' => 'movie', 'number' => 3, 'airdate' => '2008-07-25'],
            ['title' => 'Superior Ultraman 8 Brothers', 'category_id' => $this->Category('mebius'), 'type' => 'movie', 'number' => 4, 'airdate' => '2008-09-13'],
            ['title' => 'Ultraman Mebius Side Story: Ghost Reverse', 'category_id' => $this->Category('mebius'), 'type' => 'movie', 'number' => 5, 'airdate' => '2009-11-25'],
            ...
            ['title' => 'Ultra Galaxy Legend Side Story: Ultraman Zero VS Darklops Zero', 'category_id' => $this->Category('zero'), 'type' => 'movie', 'number' => 3, 'airdate' => '2010-11-26'],
            ['title' => 'Ultraman Zero Side Story: Killer the Beatstar', 'category_id' => $this->Category('zero'), 'type' => 'movie', 'number' => 4, 'airdate' => '2011-11-25'],
            ['title' => 'Ultraman Saga', 'category_id' => $this->Category('zero'), 'type' => 'movie', 'number' => 5, 'airdate' => '2012-03-24'],
            ['title' => 'Ultra Zero Fight: A New Power', 'category_id' => $this->Category('zero'), 'type' => 'movie', 'number' => 6, 'airdate' => '2012-08-01'],
            ['title' => 'Ultra Zero Fight: Shining Zero', 'category_id' => $this->Category('zero'), 'type' => 'movie', 'number' => 7, 'airdate' => '2012-12-12'],
            ['title' => 'Ultraman Ginga S the Movie: Showdown! Ultra 10 Warriors!', 'category_id' => $this->Category('ginga'), 'type' => 'movie', 'number' => 1, 'airdate' => '2015-03-14'],
            ['title' => 'Ultra Fight Victory', 'category_id' => $this->Category('ginga-s'), 'type' => 'movie', 'number' => 1, 'airdate' => '2015-03-31'],
            ['title' => 'Ultraman X The Movie: Here It Comes! Our Ultraman', 'category_id' => $this->Category('x'), 'type' => 'movie', 'number' => 1, 'airdate' => '2016-03-12'],
            ['title' => 'Ultraman Orb: The Origin Saga', 'category_id' => $this->Category('orb'), 'type' => 'movie', 'number' => 1, 'airdate' => '2016-12-26'],
            ['title' => "Ultraman Orb The Movie: I'm Borrowing the Power of Your Bonds!", 'category_id' => $this->Category('orb'), 'type' => 'movie', 'number' => 2, 'airdate' => '2017-03-11'],
            ['title' => 'Ultra Fight Orb', 'category_id' => $this->Category('orb'), 'type' => 'movie', 'number' => 3, 'airdate' => '2017-04-15'],
            ...
            ['title' => 'Ultra Galaxy Fight: New Generation Heroes', 'category_id' => $this->Category('zero'), 'type' => 'movie', 'number' => 8, 'airdate' => '2019-09-29'],
            ...
            ['title' => 'Ultra Galaxy Fight: The Absolute Conspiracy', 'category_id' => $this->Category('zero'), 'type' => 'movie', 'number' => 9, 'airdate' => '2020-11-22'],
            ['title' => 'Ultraman Trigger: Episode Z', 'category_id' => $this->Category('trigger'), 'type' => 'movie', 'number' => 1, 'airdate' => '2022-03-18'],
            ['title' => 'Ultra Galaxy Fight: The Destined Crossroad', 'category_id' => $this->Category('zero'), 'type' => 'movie', 'number' => 10, 'airdate' => '2022-04-29'],
