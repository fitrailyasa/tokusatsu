...
class MovieSuperSentaiSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $data = collect([
            ...
            ['title' => 'Space Squad: Space Sheriff Gavan vs Tokusou Sentai Dekaranger', 'category_id' => $this->Category('dekaranger'), 'type' => 'movie', 'number' => 3, 'airdate' => '2017-06-17'],
            ...
            ['title' => 'Ohsama Sentai King-Ohger: The Secrets of King Racules', 'category_id' => $this->Category('king-ohger'), 'type' => 'movie', 'number' => 1, 'airdate' => '2023-04-23'],
            ...
            ['title' => 'Ninpuu Sentai Hurricaneger Degozaru! Shushuuto 20th Anniversary', 'category_id' => $this->Category('hurricaneger'), 'type' => 'movie', 'number' => 3, 'airdate' => '2023-06-16'],
            ['title' => 'Ohsama Sentai King-Ohger: Adventure Heaven', 'category_id' => $this->Category('king-ohger'), 'type' => 'movie', 'number' => 2, 'airdate' => '2023-07-28'],
            ...
            ['title' => 'Ohsama Sentai King-Ohger vs Donbrothers', 'category_id' => $this->Category('king-ohger'), 'type' => 'movie', 'number' => 3, 'airdate' => '2024-04-26'],
            ['title' => 'Ohsama Sentai King-Ohger vs Kyoryuger', 'category_id' => $this->Category('king-ohger'), 'type' => 'movie', 'number' => 4, 'airdate' => '2024-04-26'],
            ['title' => 'Tokusou Sentai Dekaranger 20th: Fireball Booster', 'category_id' => $this->Category('dekaranger'), 'type' => 'movie', 'number' => 4, 'airdate' => '2024-06-07'],
            ['title' => 'Tokusou Sentai Dekaranger with Tonbo Ohger', 'category_id' => $this->Category('dekaranger'), 'type' => 'movie', 'number' => 5, 'airdate' => '2024-06-16'],
            ...
            ['title' => 'Ohsama Sentai King-Ohger in Space', 'category_id' => $this->Category('king-ohger'), 'type' => 'movie', 'number' => 5, 'airdate' => '2024-11-10'],
