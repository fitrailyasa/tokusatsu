    ...
    public function run(): void
    {
        $data = [
            [
                'name' => 'Showa',
                'slug' => Str::slug('Showa', '-'),
                'desc' => 'The Shōwa era (昭和時代, Shōwa jidai, [ɕoːwadʑidai] ⓘ) was a historical period of Japanese history corresponding to the reign of Emperor Shōwa (Hirohito) from December 25, 1926, until his death on January 7, 1989.[1] It was preceded by the Taishō era and succeeded by the Heisei era. The pre-1945 and post-war Shōwa periods are almost completely different states: the pre-1945 Shōwa era (1926–1945) concerns the Empire of Japan, and post-1945 Shōwa era (1945–1989) concerns the State of Japan.',
