...
class CategorySeeder extends Seeder
{
    ...
    public function run(): void
    {
        $categories = [
            [
                'id' => Str::uuid(),
                'era_id' => $this->getOrCreateEraId('Showa'),
                'franchise_id' => $this->getOrCreateFranchiseId('Kamen Rider'),
                'name' => 'Kamen Rider',
            ...
            [
                'id' => Str::uuid(),
                'era_id' => $this->getOrCreateEraId('Heisei'),
                'franchise_id' => $this->getOrCreateFranchiseId('Kamen Rider'),
                'name' => 'Kuuga',
            ...
            [
                'id' => Str::uuid(),
                'era_id' => $this->getOrCreateEraId('Reiwa'),
                'franchise_id' => $this->getOrCreateFranchiseId('Kamen Rider'),
                'name' => 'Zero-One',
            ...
            [
                'id' => Str::uuid(),
                'era_id' => $this->getOrCreateEraId('Showa'),
                'franchise_id' => $this->getOrCreateFranchiseId('Super Sentai'),
            ...
            [
                'id' => Str::uuid(),
                'era_id' => $this->getOrCreateEraId('Showa'),
                'franchise_id' => $this->getOrCreateFranchiseId('Ultraman'),
                'name' => 'Ultraman',
    ...
    private function getOrCreateEraId(string $name): string
    {
    ...
    private function getOrCreateFranchiseId(string $name): string
    {
